...
<?php
session_start();
$connect = mysqli_connect("localhost", "root", "", "carro_compras");
	...
	<div class="container">
		...
		?>
				<div class="col-md-4">
					...
					<div style="border:1px solid #000; background-color:white; border-radius:5px; padding:16px;" align="center">
							<img src="images/<?php echo $row["image"]; ?>" class="img-responsive" /><br />

							<h4 class="text-black" style="color:black"><?php echo $row["name"]; ?></h4>
